...
export default function Portfolio() {
  ...
  return (
    <div className="bg-background-dark text-slate-100 font-sans selection:bg-primary selection:text-black">
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center w-full relative z-10 pointer-events-auto">
          <div>
            ...
            <h2 className="text-xl md:text-2xl text-slate-400 font-light mb-12 max-w-lg leading-relaxed">
              CyberSecurity | Full Stack Developer. Building scalable web applications and exploring the intersection of AI and software engineering.
            </h2>
            <div className="flex flex-wrap gap-6">
              ...
              <div className="flex gap-4">
                ...
                <a className="px-10 py-5 border border-white/20 text-white font-black uppercase tracking-widest text-sm hover:bg-white hover:text-black transition-colors" href="/Jainam Jyoat (1).pdf">
                  Resume
                </a>
              </div>
            </div>
      ...
      {/* About Section */}
      <section className="py-32 border-t border-white/5 relative overflow-hidden bg-background-dark/80 backdrop-blur-sm" id="about">
