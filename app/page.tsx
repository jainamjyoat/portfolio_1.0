        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center w-full relative z-10 pointer-events-auto">
          ...
          <div className="pt-10">
            ...
            <div className="flex flex-wrap gap-4 items-center">
              ...
              <a className="px-8 py-4 h-12 border border-white/20 text-white font-bold uppercase tracking-widest text-xs hover:bg-white/10 transition-colors flex items-center justify-center" href="./resume">
                Resume
              </a>
            </div>
          </div>
