...
class LightsSticks {
  ...
  init(sideMultiplier: number) {
    ...
    instanced.setAttribute('aOffsetX', new THREE.InstancedBufferAttribute(new Float32Array(aOffsetX), 1, false));
    instanced.setAttribute('aColor', new THREE.InstancedBufferAttribute(new Float32Array(aColor), 3, false));
...
class App {
  ...
  tick() {
    ...
    if (resizeRendererToDisplaySize(this.renderer, this.container, this.setSize)) {
      if (this.hasValidSize) {
